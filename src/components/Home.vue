<template>
  ...
  <div class="container">
    ...
    <li>
      Data structure and algorithms (Array, Hash Table, Linked List, Binary
      tree, Merge sort, Time and Space Complexity)
    </li>
    <li>Multiprocessing System</li>
...
<style scoped>
@import url("http://fonts.cdnfonts.com/css/lucida-console");
.container h1,
.container h2,
.container h3,
.container h4 {
